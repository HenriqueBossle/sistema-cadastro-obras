...
<h1 class="mb-5 text-white p-5 font-bold border-solid bg-red-500 rounded-xl">Editar os campos abaixo para atualizar as informações do cadastro já existente</h1>
   ...
   <div class="mb-5">
      ...
      <input type="date" name="date" id="date" value="{{ $construction->date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
   </div>
   <div class="mb-5">
